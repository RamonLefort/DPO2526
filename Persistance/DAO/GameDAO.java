...
public class GameDAO {
	...
	/**
	 * Registra una nueva partida en el sistema, inicializando sus valores con los
	 * parámetros predeterminados de configuración inicial.
	 *
	 * @param nameGame Nombre identificativo asignado a la partida.
	 * @param username Nombre del usuario al que pertenece la partida.
	 * @return El ID numérico autogenerado por la base de datos para la nueva partida.
	 ...
	 * @return Una lista de los ids de los juegos que tiene un usuario
	 * @throws PersistanceException Si ocurre un error de comunicación o ejecución durante la inserción en la base de datos.
	 */
